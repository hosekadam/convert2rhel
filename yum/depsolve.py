...
class Depsolve(object):
    ...
    def __init__(self):
        ...
        self.verbose_logger = self.logger
    ...
    def resolveDeps(self, full_check=True, skipping_broken=False):
        ...
        while True:
            if depsolve_loop_count == (self.conf.depsolve_loop_limit or -1):
                try:
                    print("Depsolving loop limit reached. %s" % str(errors))
                except TypeError:
                    pass
            ...
            while CheckDeps:
                ...
                try:
                    print("CheckDeps missing from resolveRequires: %s" % str(missing))
                except TypeError:
                    pass
            ...
            if CheckRemoves:
                ...
                if CheckDeps:
                    ...
                    print('Restarting Loop in CheckDeps under CheckRemoves')
                    continue
            ...
            if CheckInstalls:
                ...
                if CheckDeps:
                    if self.dsCallback: self.dsCallback.restartLoop()
                    self.verbose_logger.log(logginglevels.DEBUG_1, _('Restarting Loop'))
                    print('Restarting Loop in CheckDeps under CheckInstalls')
                    continue
        ...
        if len(errors) > 0:
            ...
            return (1, errors)
        try:
            print("Missing deps: %s" % str(missingdep))
            print("Errors %s" % str(errors))
            print("tsInfo: %s" % str(self.tsInfo))
        except TypeError:
            pass
